...
final readonly class OrderPlaced
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'period' => $this->order->betData()->period(),
            'type' => $this->order->betData()->type(),
            'channels' => $this->order->betData()->channels(),
            'number' => $this->order->betData()->number(),
            'expanded_numbers' => $this->order->expandedNumbers(),
