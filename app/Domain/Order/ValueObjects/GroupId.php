...
final readonly class GroupId implements Stringable
{
    ...
    public static function generate(): self
    {
        ...
        return new self(sprintf('GRP-%s-%s', $timestamp, $random));
    }
    ...
    private function validate(): void
    {
        ...
        if (in_array(preg_match('/^GRP-\d{14}-\d{6}$/', $this->value), [0, false], true)) {
